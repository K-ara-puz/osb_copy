<template>
  <div class="main">
    <div class="main__top-img _anim-scroll _anim-no-hide">
      <div class="main__top-img__title _anim-scroll _anim-no-hide">культура & этика</div>
    </div>
    ...
    <div class="main__our-world">
      ...
      <div class="main__our-world__descriptions">
        <div class="main__our-world__descriptions__section">
          <div class="main__our-world__descriptions__section__image _anim-scroll _anim-no-hide">
            <img :src="require('../../assets/main-jpg/OUR1' + '.webp')" />
          </div>
          <div class="main__our-world__descriptions__section__text _anim-scroll _anim-no-hide">
    ...
    <div class="main__notifications">
        <div class="main__notifications__left-bar">
            <div class="main__notifications__left-bar__title _anim-scroll _anim-no-hide">
                Узнавайте новости первыми
            </div>
            <div class="main__notifications__border _anim-scroll _anim-no-hide"></div>
            <div class="main__notifications__left-bar__article _anim-scroll _anim-no-hide">
        ...
        >
            <div class="main__notifications__right-bar__follow-btn _anim-scroll _anim-no-hide">
                <CustomBtn
                    :purple="true"
                    :title="'Подписаться'"
                >
    ...
    <section class="main__call-order _anim-scroll _anim-no-hide">
        <div class="main__call-order__container">
            <form class="main__call-order__form">
                ...
                <button class="main__call-order__form__submit _anim-scroll _anim-no-hide">
