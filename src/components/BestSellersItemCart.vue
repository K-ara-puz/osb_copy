<template>
    ...
    <div class="best-seller__container">
      <div
        ...
        v-if="this.isActiveSelect === true"
      >
        <input v-model="this.selectValue" type="checkbox" @change="this.checkHandler($event.target)">
      ...
      <div class="best-seller__bottom-bar bottom-bar-best-seller">
        <div class="bottom-bar-best-seller__panel">
          <div class="bottom-bar-best-seller__container">
            ...
            <ProductLikesService class="bottom-bar-best-seller__panel__ic" :current-product="this.productData"></ProductLikesService>
...
import ProductLikesService from './ProductLikesService.vue';
    ...
    methods: {
        ...
        checkHandler(input) {
            if (input.checked === true) {
                this.$emit("pr-selected", this.productData);
                this.selectValue = true;
            }
            else {
                this.$emit("pr-unselected", this.productData);
    ...
    watch: {
        forcedSelect() {
            if (this.forcedSelect === true) {
                this.selectValue = true;
                this.$emit("forced-select", this.productData);
            }
            else {
                this.selectValue = false;
            }
